...
const Kat1: Workout = {
  ...
  exercises: [
    ...
    { name: 'Plank', type: ExerciseType.Interval, duration: 30 },
    { name: 'Rest', type: ExerciseType.Rest, duration: 30 },
    { name: 'Side leg raise (left)', type: ExerciseType.Reps, reps: 10 },
    { name: 'Rest', type: ExerciseType.Rest, duration: 30 },
    { name: 'Side leg raise (right)', type: ExerciseType.Reps, reps: 10 },
    { name: 'Rest', type: ExerciseType.Rest, duration: 30 },
    { name: 'Side leg raise (left)', type: ExerciseType.Reps, reps: 10 },
    { name: 'Rest', type: ExerciseType.Rest, duration: 30 },
    { name: 'Side leg raise (right)', type: ExerciseType.Reps, reps: 10 },
...
const Kat3: Workout = {
  ...
  exercises: [
    ...
    { name: 'flutter kick', type: ExerciseType.Interval, duration: 30 },
    { name: 'Rest', type: ExerciseType.Rest, duration: 30 },
    { name: 'Goblet dumbell squats', type: ExerciseType.Reps, reps: 12 },
    { name: 'Rest', type: ExerciseType.Rest, duration: 30 },
    { name: 'Goblet dumbell squats', type: ExerciseType.Reps, reps: 12 },
    { name: 'Rest', type: ExerciseType.Rest, duration: 30 },
